...
function buildConfigRow(
  overrides: Partial<MarketDataProviderConfigModel> = {},
  ...
  return {
    ...
    lastConnectionTestAt: overrides.lastConnectionTestAt ?? null,
    lastConnectionTestStatus: overrides.lastConnectionTestStatus ?? null,
  };
}
