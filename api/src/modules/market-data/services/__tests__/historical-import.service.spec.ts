...
import type { QualityScoringService } from "../quality-scoring.service";
...
describe("HistoricalImportService", () => {
  ...
  function buildDeps() {
    ...
    const orchestration = { executeWithRetry: jest.fn(), getCircuitState: jest.fn().mockReturnValue("closed") } as unknown as ProviderOrchestrationService;
    ...
    const qualityScoringService = { scoreImportedCandle: jest.fn().mockResolvedValue({}) } as unknown as QualityScoringService;
