...
export class CouponRepository {
  ...
  /** Module 005 addition — Domain 2's Coupon Management admin listing (create/validate/apply already existed; a "list all coupons" read was missing). */
  findAll(client: DbClient = prisma): Promise<Coupon[]> {
    return client.coupon.findMany({ orderBy: { createdAt: "desc" } });
  }
}
