...
export class SubscriptionService {
  ...
  async createSubscription(
    ...
    await this.eventPublisher.publish(MOD005_EVENTS.SUBSCRIPTION_CREATED, {
  ...
  async changePlan(organizationId: string, newPlanKey: string, actorId: string, ctx: AuditContext = {}): Promise<OrganizationSubscription> {
    ...
    await this.eventPublisher.publish(MOD005_EVENTS.SUBSCRIPTION_UPDATED, {
      subscriptionId: subscription.id,
      organizationId,
  ...
  async cancelSubscription(
    ...
    await this.eventPublisher.publish(MOD005_EVENTS.SUBSCRIPTION_CANCELLED, {
      subscriptionId: subscription.id,
      organizationId,
    });
    return cancelled;
